...
async function main() {
  ...
  assert(html.includes("mode === 'dock' ? { width: 128, height: 52 }"), "edge dock weather viewport is missing");
  ...
  assert(mainSource.includes("width: DOCK_W, height: DOCK_H"), "edge dock drag does not lock its compact size");
